...
public class IncrementalSeekBarPreference extends DialogPreference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String CLASS_TAG = IncrementalSeekBarPreference.class.getCanonicalName();

    public IncrementalSeekBarPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    protected void onSetInitialValue(boolean restore, Object defaultValue) {
        ...
        if(defaultValue instanceof String){
        	defValue = Integer.parseInt((String) defaultValue);
        }
        
        if (restore)
            mValue = shouldPersist() ? getPersistedInt(mDefault) : mMin;
        else
            mValue = (defValue > mMin) ? defValue : mMin;
    }
    ...
    public void setProgress(int progress) {
    	...
    	progress = progress*INCREMENT_VALUE;
